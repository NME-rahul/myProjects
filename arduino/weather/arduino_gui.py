...
text = Text(master, height = 5, width = 52, bg='light cyan', xscrollcommand=h.set, yscrollcommand=v.set)
...
class ReadJSON(SerialCommunication):
    ...
    keys = ['coord', 'weather', 'main', 'visibility', 'wind', 'clouds', 'sys', 'timezone']
